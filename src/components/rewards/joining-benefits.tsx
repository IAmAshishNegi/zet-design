...
export function JoiningBenefits() {
  ...
  return (
    <View>
      ...
      <View>
        <Card
          title="Redeem Benefits worth ₹21,000"
          ...
          variant="secondary"
          badge={{ text: "CARD JOINING BENEFITS", variant: "new" }}
          onPress={() => handleCardPress('Member Benefits')}
          className="bg-neutral-0"
          showButton={true}
          buttonProps={buttonProps}
          gradientColors={['#ffffff', '#fffdf6', '#fdb99c'] as const}
