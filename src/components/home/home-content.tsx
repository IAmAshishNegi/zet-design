...
} from "../../components/recharges";
import { DiscountBanner, DiscountSection } from "../../components/discounts";
import { SpotlightSection, SpotlightItem } from "../../components/carousel";
import { H3, ButtonSm, SH5, Button, Divider, SH6, B5 } from "../ui";
      ...
      <View className="flex flex-row px-4 gap-4 w-full">
        <Link href="/design-system" asChild>
          <Pressable className="w-1/2">
            <ButtonSm className="bg-primary-100 text-white p-3 w-full">
              Design System
            </ButtonSm>
          </Pressable>
        </Link>

        <Pressable className="w-1/2" onPress={resetOnboarding}>
          <ButtonSm className="bg-error-100 text-white p-3 w-full">
            Reset Onboarding
          </ButtonSm>
        </Pressable>
      </View>
